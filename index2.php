...
<head>
  ...
  <title>S-Monter Apps - Login Admin</title>
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Welcome Admin To S-Monter Apps!</h1>
                  </div>
                  <form class="user" method="post" action="proses-login2.php">
                    ...
                    <a href="index.php" class="btn btn-success btn-user btn-block">
                      <i class="fa fa-laptop fa-fw"></i> Back to Login User Page
                    </a>
                  </form>
                </div>
              </div>
